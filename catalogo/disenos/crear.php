...
// SECCION PARA VALIDAR DATOS DEL FORMULARIO
 ...
 //echo "<p>$nMangas</p>";
  ...
  // if(!$nMangas){
  //  $errores[]= "EL numero de estampados en la manga es obligatorio";
  // }
...
if(empty(($errores))){
  ...
  $query = "INSERT INTO disenos (titulo, precio, imagen, descripcion, nFrente, nEspalda, nMangas, creado, disenadores_id) VALUES 
  ('$titulo','$precio','$nombreImagen', '$descripcion','$nFrente','$nEspalda','$nMangas', '$creado', '$disenadores_id')";
...
echo "<script>console.log($query);</script>";
  ...
  if($resultado){
    ...
    header('Location: /catalogo?resultado=1');
  }
}
    ...
    <main class="contenedor seccion">
        ...
        <form class="formulario" method="POST" action="/catalogo/disenos/crear.php" enctype="multipart/form-data">
          <fieldset>
            ...
            <input type="text" id="titulo" name="titulo" placeholder="Titulo del articulo" value="<?php echo $titulo; ?>">
            ...
            <input type="submit" value="Agregar Artículo" class="boton boton-azul">
        </form>
